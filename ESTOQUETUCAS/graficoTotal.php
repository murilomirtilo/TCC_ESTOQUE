...
try {
    ...
    if ($stmt->rowCount() > 0) {
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            $quantidadesProdutos[] = $row['qtd_produto'];
        }
    }
...
<body>
<a href="tabelas.php" style="margin-left: 5rem" class="btn btn-success btn-export">VOLTAR</a>
                    ...
                    tooltip: {
                        callbacks: {
                            label: function (context) {
                                ...
                                label += produto + ' - ' + quantidade + ' presente(s) - ';
                                return label;
                            }
                        }
                    }
