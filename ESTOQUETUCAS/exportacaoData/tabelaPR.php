<?php
    ...
    $txtData = "ID Chave\tNome Chave\tData Chave\tResponsável\n";
    ...
    foreach ($rowTabela as $linha) {
        ...
        $txtData .= sprintf("%-8s\t%-12s\t%-10s\t%-12s\n", $idChave, $nomeChave, $dataChave,  $responsavel);
    }

    // Define o nome do arquivo com a data de download
    $fileName = 'TabelaChave-PUU' . date('Y-m-d') . '.txt';
